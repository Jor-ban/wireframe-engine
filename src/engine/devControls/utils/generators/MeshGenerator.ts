...
export class MeshGenerator {
    static addCube(camera: PerspectiveCamera | OrthographicCamera): WireframeMesh {
        return this.createMesh(new BoxGeometry(), camera)
    }
    static addSphere(camera: PerspectiveCamera | OrthographicCamera): WireframeMesh {
        return this.createMesh(new SphereGeometry(1), camera)
    }
    static addRing(camera: PerspectiveCamera | OrthographicCamera): WireframeMesh {
        return this.createMesh(new RingGeometry(), camera)
    }
    static addCircle(camera: PerspectiveCamera | OrthographicCamera): WireframeMesh {
        return this.createMesh(new RingGeometry(), camera)
    }
    static addCone(camera: PerspectiveCamera | OrthographicCamera): WireframeMesh {
        return this.createMesh(new ConeGeometry(), camera)
    }
    static addCylinder(camera: PerspectiveCamera | OrthographicCamera): WireframeMesh {
        return this.createMesh(new CylinderGeometry(), camera)
    }
    static addPlane(camera: PerspectiveCamera | OrthographicCamera): WireframeMesh {
        return this.createMesh(new PlaneGeometry(), camera)
    }
    static addDodecahedron(camera: PerspectiveCamera | OrthographicCamera): WireframeMesh {
        return this.createMesh(new DodecahedronGeometry(), camera)
    }
    static async addText(camera: PerspectiveCamera | OrthographicCamera): Promise<WireframeMesh | undefined> {
